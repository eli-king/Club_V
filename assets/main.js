...
function hideOverlay() {
    //changes overlay div display to none and unmutes background video after user clicks to enter
    document.getElementById("overlay").style.display = "none";
    document.getElementById("artist-vid").muted = false;
}

function toggleNav() {
    //toggles between nav open and close
...
//changes backgound video to from moma ready as default to selected artist
//makes api call to google storage for faster loading and playback
function acemoVid() {
...
//Ghettoville animation created by https://www.youtube.com/channel/UCEqc149iR-ALYkGM6TG-7vQ Frank's Laboratory @2020 edited by me
const image = new Image();
image.src = "assets/img/actress.jpg";
image.addEventListener('load', function () {
    ...
    class Particle {
        ...
        update() {
            ...
            //console.log(this.x += movement) used to test changed values
        }
        draw() {
            ctx.beginPath();
            ctx.fillStyle = 'white';
